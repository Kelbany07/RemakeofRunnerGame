...
This project will feature sprites mostly created by me. Any sprites from outside sources will be properly credited when the time comes. This endless runner will consist of a randomly generated layout that increases in difficulty/speed overtime. Asides from pits the player will have to jump over, I also want to add objects the player can jump over, like boxes or bottles.
